...
// GuidePage / GuideSection â€” the How-to-Play tab: an accordion of documentation
    ...
    <div className="space-y-2">
      <GuideSection id="overview" title="What Is Calendar Game?" openId={open} onToggle={toggle}>
        <p>
          ...
          given a date and must identify which weekday it falls on â€” as quickly and accurately as
        ...
        <p className="mt-2">
          ...
          â€” whether about the site or the book â€” please feel free to reach out:{' '}
      ...
      <GuideSection id="buttons" title="Buttons" openId={open} onToggle={toggle}>
        <p>
          <b>New</b> â€” load a fresh date. In timer modes, only available after pressing Begin.
        </p>
        <p>
          <b>Begin</b> â€” timer modes only (Blitz, Flash, AoX). Starts a round or run. After pressing
        ...
        <p>
          <b>Reset</b> â€” timer modes only. In Blitz, ends the current round and unlocks settings;
        ...
        <p>
          <b>Reset Stats</b> â€” casual modes only (Classic, Flash, Deduction). Clears your stats and
        ...
        <p>
          <b>Back (&lt;)</b> â€” return to the previous date. The answer is shown and the card is
        ...
        <p>
          <b>Forward (&gt;)</b> â€” move forward through dates you've browsed past with Back. The
        ...
        <p>
          <b>Reveal</b> â€” show the correct answer without guessing. Counts as a wrong attempt. No
          penalty on unanswered dates while browsing back.
        </p>
        <p>
          <b>Override</b> â€” fix a mistake. You can override any date in your history by browsing to
          ...
          (in any mode) â€” Override is enabled when the live date hasn't been answered yet, and
        ...
        <p>
          <b>Show Codes</b> â€” reveals the calculation codes for the current date. Counts as wrong if
      ...
      <GuideSection id="stats" title="Stats" openId={open} onToggle={toggle}>
        <p>
          <b>Score</b> â€” correct first-try answers out of total attempts. In Blitz, only the current
          round is shown. In AoX, shows correct answers out of total attempts; the run ends once
          correct answers reach the set number.
        </p>
        <p>
          <b>Accuracy</b> â€” percentage of questions answered correctly on the first try. Shows â€”
          until your first attempt.
        </p>
        <p>
          <b>Streak</b> â€” your current consecutive correct streak / your best in this session.
        </p>
        <p>
          <b>Last / Avg / Med</b> â€” timing stats, calculated using correct answers only. Last is
          your most recent correct time; Avg is the average across all correct answers; Med is the
          median, which is less skewed by outliers. Any time of 60 seconds or more â€” whether an
          individual solve, a computed average or median, or any Best â€” displays as "â€”". Times are
        ...
        <p>
          ...
          <i>truncated</i> to hundredths â€” the third decimal is dropped, never rounded. Averages,
        ...
        <p>When you set a new best, a small â˜… appears next to the value to flag it.</p>
        <p className="text-purple-300/70 text-[12px]">
          ...
          all three. Score, Accuracy, and Streak continue tracking in the background while hidden â€”
          re-enabling them brings the same numbers back. Timing stats behave differently: timing
          pauses entirely while hidden â€” no times are recorded. When you turn timing back on, the
          ...
          three timing stat boxes merge into a single "Enable and Reset Stats?" confirmation â€” tap
          ...
          AoX) show 'â€”' with strikethrough labels, dim, and become non-interactive â€” toggling timing
          ...
          to a mode preserves the current question exactly as you left it â€” same date, same answers,
      ...
      <GuideSection id="dateformat" title="Date Format" openId={open} onToggle={toggle}>
        <p>
          Set via the âš™ settings menu. Choose one of five real-world formats: <b>Written MDY</b>{' '}
        ...
        <p>
          ...
          used in real life â€” orderings like YDM aren't standard anywhere.
        </p>
        <p>
          <b>Random Format</b>, when on, rolls one of the five formats per date in game modes only â€”
        ...
        <p>
          In Classic, Deduction, Flash, and AoX (idle), any format setting change â€” Random Format
          toggle or Date Format dropdown â€” regenerates an unanswered date so you don't return to a
          ...
          the displayed date, the change is deferred â€” the burned state is preserved and the new
      ...
      <GuideSection id="julian" title="Julian Calendar" openId={open} onToggle={toggle}>
        <p>
          Toggle via the âš™ settings menu under Calendar System. On by default. When on, dates on or
          before October 4, 1582 are treated as Julian calendar dates, which have different leap
          year rules â€” every year divisible by 4 is a leap year, with no century exception. This
          affects weekday calculation and the codes shown in Show Codes. October 5â€“14, 1582 are
        ...
        <p>
          ...
          date stays if you haven't made a wrong guess yet â€” the answer and codes simply update. If
        ...
        <p>
          ...
          the Julian calendar period (pre-Oct 15, 1582) â€” Random uses the natural rate (which
          depends on your year range, ~16% on the default 1â€“10000 range); 25%, 50%, 75%, and 100%
      ...
      <GuideSection id="range" title="Year Range" openId={open} onToggle={toggle}>
        <p>
          Set via the âš™ settings menu. Controls which years dates are drawn from. Defaults to
          1â€“10000 AD. Changing the range always regenerates the current date â€” but if you've already
      ...
      <GuideSection id="leap" title="Leap Year Settings" openId={open} onToggle={toggle}>
        <p>
          Two settings in the âš™ menu control how often leap years appear and what months they're
          paired with. <b>Leap Year Chance</b> sets how often a generated date lands on a leap year
          â€” Random uses the natural rate (~24%); 50%, 75%, and 100% force higher rates.{' '}
          <b>Jan/Feb Chance on Leap Years</b> sets how often a leap-year date lands on January or
          February â€” Random uses the natural rate (~17%, since 2 of 12 months are Jan/Feb); 25%,
          50%, 75%, and 100% force higher rates. The listed percentage is the exact final rate of
          Jan/Feb on leap-year dates, not just a "force probability" â€” under 50%, exactly half of
      ...
      <GuideSection id="savestats" title="Save Stats" openId={open} onToggle={toggle}>
        <p>
          Toggle via the âš™ settings menu under Stats. On by default. When off, your answers don't
        ...
        <p className="mt-2">
          <b>Classic, Deduction, Flash</b> â€” per-question. The toggle's value is locked in at the
          ...
          date â€” the toggle's frozen value sticks for the question. When off, the question doesn't
          update stats and isn't pushed to history (Back can't browse to it).
        </p>
        <p className="mt-2">
          <b>Blitz</b> â€” round-level. In-round score, accuracy, streak, and Back/Forward navigation
        ...
        <p className="mt-2">
          <b>AoX</b> â€” run-level. In-run score, streak, times, and Back/Forward navigation all work
      ...
      <GuideSection id="theme" title="Theme" openId={open} onToggle={toggle}>
        <p>
          ...
          purple), Light (clean white), and Parchment (warm cream). Accessible from the âš™ settings
      ...
      >
        <p>
          <b>Reset Settings</b> â€” at the bottom-left of the âš™ menu, restores everything in the menu
          to its defaults: Random Format on, Written MDY, Julian on, Julian Chance Random, year
          range 1â€“10000, Leap Year Chance Random, Jan/Feb Chance Random, Save Stats on, and theme
          ...
          toggles) or your stats and history. No confirmation prompt â€” tap to apply. When every
          setting in the menu is already at its default, this button dims and locks since tapping it
          would have no effect.
        </p>
        <p>
          <b>Full Reset</b> â€” at the bottom-right of the âš™ menu, restores the entire site to its
          ...
          â€” both the âš™ menu and the per-mode toggles (AoX N, timer durations, Deduction sub-types
          and toggles, Allow Mistakes, Save Stats, Stop Codes, etc.). Closes any open overlay (How
          to Play, âš™ menu, codes, method breakdown) and switches to Classic. Requires two taps to
          confirm: tap once and the button changes to "Confirm?"; tap again to fire. Auto-cancels
          after a few seconds, when you close âš™, or if you tap any other control. When every
      ...
      <GuideSection id="keyboard" title="Keyboard Input" openId={open} onToggle={toggle}>
        <p>
          ...
          the site without tapping. The on-screen layout is identical to mobile â€” keyboard input is
      ...
      <GuideSection id="aox" title="AoX" openId={open} onToggle={toggle}>
        <p>
          Average your times over a set number of correct solves (2â€“1000). The score shows correct
          answers out of total attempts; the run ends when correct answers reach your target. Press
          Begin to start a run.
        </p>
        <p>
          <b>Allow Mistakes</b> â€” wrong answers don't end the run but don't count toward your score.
        </p>
        <p>
          <b>One-By-One</b> â€” hides the date between solves. Press Continue to reveal each new date.
        </p>
        <p>
          <b>Last / Avg / Med</b> â€” tap any of these to show or hide all three time stats.
        </p>
        <p>
          <b>Back/Forward</b> â€” browse previous dates from the current run without affecting it.
        ...
        <p>
          <b>Override</b> â€” after wrong: gives credit with time recorded, preserves streak. After
        ...
        <p>
          ...
          independently â€” they can come from different runs. Beneath each best, the companion metric
        ...
        <p>
          ...
          separate bucket â€” your previous bests remain stored and reappear when you switch back to
          that exact config.
        </p>
        <p>
      ...
      <GuideSection id="deduction" title="Deduction" openId={open} onToggle={toggle}>
        ...
        <p className="mt-2">
          <b>Day</b> â€” seven consecutive days are shown, each with a unique day code. The correct
          day can appear in any position. <i>October 1582 with Julian on:</i> days 5â€“14 don't exist
          (the Gregorian transition skipped them), so the valid days are 1â€“4 and 15â€“31. When the
          window can't fit seven days on one side of the gap, it shrinks to four â€” codes 1, 2, 3, 4
          repeat at days 15, 16, 17, 18, so a five-day window crossing the gap would have a
          duplicate code.
        </p>
        <p className="mt-2">
          <b>Month</b> â€” seven fixed boxes group months that share the same month code, so tapping
          ...
          applies because the Julian/Gregorian transition splits the year â€” January through
          September and October 1â€“4 use Julian (year code +1), while October 15+ and
          November/December use Gregorian (year code âˆ’2). October's box position depends on the day:
          for days 1â€“4 it joins Jan and Nov ("Jan/Oct/Nov"); for days 15â€“31 it joins Jun
          ("Jun/Oct"); for days 5â€“14 it's excluded since those dates don't exist. The other six
          boxes are arranged differently from the standard layout â€” practice carefully.
        </p>
        <p className="mt-2">
          <b>Year</b> â€” five consecutive year options. Each option has a unique year code, so only
          ...
          (the Julian/Gregorian boundary), it shrinks to two years â€” the calendar's 10-day jump
        ...
        <p className="mt-2">
          <b>Per-mode toggles</b> â€” Year mode adds <i>ab</i> Cross (left of Day/Month/Year) and Jul
          Cross (right of Day/Month/Year). Month mode adds 1582 Only (right of Day/Month/Year).
          These are mode-specific, not in the âš™ Settings menu, since they only apply to one
          Deduction sub-mode.
        </p>
        <p className="mt-2">
          <b>
          ...
          (Year mode) â€” when on, the five-year window must cross a year ending in 00 (any 100-year
        ...
        <p className="mt-2">
          <b>Jul Cross</b> (Year mode) â€” when on, the two-year window must cross October 15, 1582
        ...
        <p className="mt-2">
          <b>Both Year toggles on</b> â€” each puzzle randomly picks (50/50) which constraint to
          enforce. The two can't both be true for the same window.
        </p>
        <p className="mt-2">
          <b>1582 Only</b> (Month mode) â€” when on, every puzzle uses year 1582, forcing the special
        ...
        <p className="mt-2">
          Switch subtypes anytime â€” progress in each is preserved, including question history. Stats
      ...
      <GuideSection id="flash" title="Flash" openId={open} onToggle={toggle}>
        <p>
          The date is briefly revealed (0.1sâ€“3.0s, default 0.5s, adjustable via the slider) then
        ...
        <p>
          While the date is showing you can also press Reveal or Show Codes â€” both freeze the
      ...
      <GuideSection id="blitz" title="Blitz" openId={open} onToggle={toggle}>
        ...
        <p>
          <b>Allow Mistakes</b> â€” when on, wrong answers count against accuracy but don't end the
          round. When off, a wrong answer ends the round immediately.
        </p>
        <p>
          <b>Per Round / Per Question</b> â€” tap to switch. Per Round uses a single countdown for the
          whole round (10sâ€“3m, default 60s). Per Question gives each question its own countdown
          (1sâ€“20s, default 5s); running out of time ends the round. Per Question always enforces no
        ...
        <p>
          ...
          Codes, or â€” with Allow Mistakes off (or in Per Question) â€” if you override a correct answer
        ...
        <p>
          ...
          on/off). Changing any of these creates a separate bucket â€” your previous bests remain
      ...
      <GuideSection id="lookup" title="Lookup" openId={open} onToggle={toggle}>
        <p>
          ...
          Supports years 1â€“10000. Show Codes is available for all results and stays open as you
          browse your history. The history panel shows up to 10 entries before scrolling and
          re-renders live when you change the Date Format. October 5â€“14, 1582 never existed and will
