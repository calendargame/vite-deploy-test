...
export function MethodExplanation({date,useJulian=false,displayedFormat='written-mdy',cellDates=null}){
...
export function MethodBreakdownSection({date,open:controlledOpen,onOpenChange,className,contentClassName,useJulian=false,displayedFormat='written-mdy',cellDates=null}){
